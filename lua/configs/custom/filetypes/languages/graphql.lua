...
local settins = {
    lsp_config = "lsp.custom.languages.graphql",
    lsp_command = ":LspStart graphql"
}

if funcs.file_exists(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "graphql.lua") then
    config_file = dofile(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "graphql.lua")
