...
local settins = {
    lsp_config = "lsp.custom.languages.lua",
    lsp_command = ":LspStart sumneko_lua"
}

if funcs.file_exists(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "lua.lua") then
    config_file = dofile(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "lua.lua")
