...
local settins = {
    lsp_config = "lsp.custom.languages.python",
    lsp_command = ":LspStart pyright"
}

if funcs.file_exists(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "python.lua") then
    config_file = dofile(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "python.lua")
