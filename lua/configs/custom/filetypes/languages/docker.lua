...
local settins = {
    lsp_config = "lsp.custom.languages.docker",
    lsp_command = ":LspStart dockerls"
}

if funcs.file_exists(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "docker.lua") then
    config_file = dofile(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "docker.lua")
