...
local settins = {
    lsp_config = "lsp.custom.languages.cpp",
    lsp_command = ":LspStart clangd"
}

if funcs.file_exists(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "cpp.lua") then
    config_file = dofile(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "cpp.lua")
