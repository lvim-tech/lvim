...
local settins = {
    lsp_config = "lsp.custom.languages.css",
    lsp_command = ":LspStart cssls"
}

if funcs.file_exists(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "css.lua") then
    config_file = dofile(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "css.lua")
