...
local settins = {
    lsp_config = "lsp.custom.languages.php",
    lsp_command = ":LspStart intelephense"
}

if funcs.file_exists(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "php.lua") then
    config_file = dofile(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "php.lua")
