...
local settins = {
    lsp_config = "lsp.custom.languages.go",
    lsp_command = ":LspStart gopls"
}

if funcs.file_exists(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "go.lua") then
    config_file = dofile(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "go.lua")
