...
local settins = {
    lsp_config = "lsp.global.languages.yaml",
    lsp_command = ":LspStart yamlls"
}

if funcs.file_exists(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "yaml.lua") then
    config_file = dofile(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "yaml.lua")
