...
local settins = {
    lsp_config = "lsp.global.languages.latex",
    lsp_command = ":LspStart texlab"
}

if funcs.file_exists(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "latex.lua") then
    config_file = dofile(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "latex.lua")
