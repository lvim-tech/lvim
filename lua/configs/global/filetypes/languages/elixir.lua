...
local settins = {
    lsp_config = "lsp.global.languages.elixir",
    lsp_command = ":LspStart elixirls"
}

if funcs.file_exists(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "elixir.lua") then
    config_file = dofile(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "elixir.lua")
