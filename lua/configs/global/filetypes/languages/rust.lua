...
local settins = {
    lsp_config = "lsp.global.languages.rust",
    lsp_command = ":LspStart rust_analyzer"
}

if funcs.file_exists(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "rust.lua") then
    config_file = dofile(cwd .. global.path_sep .. ".lvim" .. global.path_sep .. "rust.lua")
