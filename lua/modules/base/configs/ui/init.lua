...
return {
    ...
    lvim_winpick = {
        config = function()
            ...
            -- `gpp` window-picker key lives in the central manifest (modules/base/keys.lua).
        end,
    },
    ...
    lvim_winmove = {
        config = function()
            ...
            -- `<C-c>w` win-move key lives in the central manifest (modules/base/keys.lua).
        end,
    },
    ...
    lvim_keys_helper = {
        config = function()
            local ok, kh = pcall(require, "lvim-keys-helper")
            if not ok then
                return
            end
            kh.setup({
                ...
                style = _G.LVIM.settings.keyshelperstyle or "mini",
                ...
                groups = require("modules.base.keys_apply").resolve().groups,
            })
        end,
    },
    ...
    lvim_files = {
        ...
        config = function()
            ...
            require("lvim-files").setup({
                ...
                keys = require("modules.base.keys_apply").plugin("lvim-files"),
            })
            -- Its keys (<S-x>, <C-c><C-f>, <S-q>) live in the central manifest
            -- (modules/base/keys.lua) with every other launcher.
        end,
    },
    ...
    lvim_shell = {
        config = function()
            ...
            -- the central manifest: modules/base/keys.lua → <Leader>o* (Open / Tools).
    ...
    lvim_term = {
        config = function()
            ...
            term.setup({ keys = require("modules.base.keys_apply").plugin("lvim-term") })
            ...
            -- Terminal-mode <Esc> lives in the central manifest (modules/base/keys.lua → keys.global.terminal).
        end,
    },
