...
config.neotest = function()
    ...
    vim.keymap.set("n", "<leader>nr", ":NeotestRun<CR>", { desc = "Neotest Run" })
    vim.keymap.set("n", "<leader>nc", ":NeotestRunCurrent<CR>", { desc = "Neotest Run Current File" })
    vim.keymap.set("n", "<leader>nd", ":NeotestRunDap<CR>", { desc = "Neotest Run with DAP" })
    vim.keymap.set("n", "<leader>ns", ":NeotestStop<CR>", { desc = "Neotest Stop" })
    vim.keymap.set("n", "<leader>na", ":NeotestAttach<CR>", { desc = "Neotest Attach" })
    vim.keymap.set("n", "<leader>no", ":NeotestOutput<CR>", { desc = "Neotest Output" })
    vim.keymap.set("n", "<leader>np", ":NeotestOutputPanel<CR>", { desc = "Neotest Output" })
    vim.keymap.set("n", "<leader>nt", ":NeotestSummary<CR>", { desc = "Neotest Summary Toggle" })
end
